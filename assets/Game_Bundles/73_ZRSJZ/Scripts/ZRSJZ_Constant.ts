...
export enum ZRSJZ_PANEL {
    ...
    英雄碎片弹窗 = "73_ZRSJZ/Prefabs/Panel/英雄碎片弹窗",
...
export const ZRSJZ_PANEL_PATH_CONFIG: Map<string, string> = new Map([
    ["主页", "主页"],
    ["游戏场景", "游戏场景"],
    ["任务", "主页-任务界面"],
    ["仓库", "主页-仓库界面"],
...
export const ZRSJZ_PROP_CONFIG: Map<string, {
    ...
    ["英雄碎片", { Name: "英雄碎片", Quality: ZRSJZ_PROP_QUALITY.紫色, GridType: ZRSJZ_GRID_TYPE._1x1, PropType: "物品", UnitPrice: 0, MaxCount: 1 }],
    ...
    ["兔月盔", { Name: "兔月盔", Quality: ZRSJZ_PROP_QUALITY.绿色, GridType: ZRSJZ_GRID_TYPE._1x1, PropType: "头盔", UnitPrice: 110000, MaxCount: 1 }],
    ["竹月盔", { Name: "竹月盔", Quality: ZRSJZ_PROP_QUALITY.蓝色, GridType: ZRSJZ_GRID_TYPE._1x1, PropType: "头盔", UnitPrice: 235000, MaxCount: 1 }],
    ["萌龙盔", { Name: "萌龙盔", Quality: ZRSJZ_PROP_QUALITY.紫色, GridType: ZRSJZ_GRID_TYPE._1x1, PropType: "头盔", UnitPrice: 415000, MaxCount: 1 }],
    ["裂光盔", { Name: "裂光盔", Quality: ZRSJZ_PROP_QUALITY.金色, GridType: ZRSJZ_GRID_TYPE._1x1, PropType: "头盔", UnitPrice: 1580000, MaxCount: 1 }],
    ["弑神盔", { Name: "弑神盔", Quality: ZRSJZ_PROP_QUALITY.红色, GridType: ZRSJZ_GRID_TYPE._1x1, PropType: "头盔", UnitPrice: 6000000, MaxCount: 1 }],
    ["光明盔", { Name: "光明盔", Quality: ZRSJZ_PROP_QUALITY.红色, GridType: ZRSJZ_GRID_TYPE._1x1, PropType: "头盔", UnitPrice: 7500000, MaxCount: 1 }],
    ["冥辉盔", { Name: "冥辉盔", Quality: ZRSJZ_PROP_QUALITY.红色, GridType: ZRSJZ_GRID_TYPE._1x1, PropType: "头盔", UnitPrice: 9000000, MaxCount: 1 }],
    //防弹衣
    ...
    ["兔萌甲", { Name: "兔萌甲", Quality: ZRSJZ_PROP_QUALITY.绿色, GridType: ZRSJZ_GRID_TYPE._2x2, PropType: "防弹衣", UnitPrice: 140000, MaxCount: 1 }],
    ["玄竹甲", { Name: "玄竹甲", Quality: ZRSJZ_PROP_QUALITY.蓝色, GridType: ZRSJZ_GRID_TYPE._2x2, PropType: "防弹衣", UnitPrice: 350000, MaxCount: 1 }],
    ["绿龙甲", { Name: "绿龙甲", Quality: ZRSJZ_PROP_QUALITY.紫色, GridType: ZRSJZ_GRID_TYPE._2x2, PropType: "防弹衣", UnitPrice: 620000, MaxCount: 1 }],
    ["星轨甲", { Name: "星轨甲", Quality: ZRSJZ_PROP_QUALITY.金色, GridType: ZRSJZ_GRID_TYPE._2x2, PropType: "防弹衣", UnitPrice: 2380000, MaxCount: 1 }],
    ["赤锋甲", { Name: "赤锋甲", Quality: ZRSJZ_PROP_QUALITY.红色, GridType: ZRSJZ_GRID_TYPE._2x2, PropType: "防弹衣", UnitPrice: 9000000, MaxCount: 1 }],
    ["圣翎甲", { Name: "圣翎甲", Quality: ZRSJZ_PROP_QUALITY.红色, GridType: ZRSJZ_GRID_TYPE._2x2, PropType: "防弹衣", UnitPrice: 11250000, MaxCount: 1 }],
    ["噬星甲", { Name: "噬星甲", Quality: ZRSJZ_PROP_QUALITY.红色, GridType: ZRSJZ_GRID_TYPE._2x2, PropType: "防弹衣", UnitPrice: 13500000, MaxCount: 1 }],
    //背包
    ...
    ["兔绒包", { Name: "兔绒包", Quality: ZRSJZ_PROP_QUALITY.绿色, GridType: ZRSJZ_GRID_TYPE._2x2, PropType: "背包", UnitPrice: 120000, MaxCount: 1 }],
    ["云竹包", { Name: "云竹包", Quality: ZRSJZ_PROP_QUALITY.蓝色, GridType: ZRSJZ_GRID_TYPE._2x2, PropType: "背包", UnitPrice: 280000, MaxCount: 1 }],
    ["恐仔囊", { Name: "恐仔囊", Quality: ZRSJZ_PROP_QUALITY.紫色, GridType: ZRSJZ_GRID_TYPE._2x2, PropType: "背包", UnitPrice: 500000, MaxCount: 1 }],
    ["天穹包", { Name: "天穹包", Quality: ZRSJZ_PROP_QUALITY.金色, GridType: ZRSJZ_GRID_TYPE._2x2, PropType: "背包", UnitPrice: 1900000, MaxCount: 1 }],
    ["赤辉囊", { Name: "赤辉囊", Quality: ZRSJZ_PROP_QUALITY.红色, GridType: ZRSJZ_GRID_TYPE._2x2, PropType: "背包", UnitPrice: 7200000, MaxCount: 1 }],
    ["烬菱包", { Name: "烬菱包", Quality: ZRSJZ_PROP_QUALITY.红色, GridType: ZRSJZ_GRID_TYPE._2x2, PropType: "背包", UnitPrice: 9000000, MaxCount: 1 }],
    ["虚空匣", { Name: "虚空匣", Quality: ZRSJZ_PROP_QUALITY.红色, GridType: ZRSJZ_GRID_TYPE._2x2, PropType: "背包", UnitPrice: 10800000, MaxCount: 1 }],
    //枪
    ...
    ["霜月狼", { Name: "霜月狼", Quality: ZRSJZ_PROP_QUALITY.红色, GridType: ZRSJZ_GRID_TYPE._1x2, PropType: "枪", UnitPrice: 7000000, MaxCount: 1 }],
    ["裂海鲨", { Name: "裂海鲨", Quality: ZRSJZ_PROP_QUALITY.红色, GridType: ZRSJZ_GRID_TYPE._1x2, PropType: "枪", UnitPrice: 9000000, MaxCount: 1 }],
    ["焚天龙", { Name: "焚天龙", Quality: ZRSJZ_PROP_QUALITY.红色, GridType: ZRSJZ_GRID_TYPE._1x2, PropType: "枪", UnitPrice: 13000000, MaxCount: 1 }],
    //刀
...
export const ZRSJZ_PROP_DESCRIPTION: ReadonlyMap<string, string> = new Map([
    ...
    ["兔月盔", "以月兔为主题的2级防护头盔，可爱的造型下藏着坚固的复合装甲。"],
    ["竹月盔", "以竹影与月色为主题的3级头盔，层叠防护结构能有效缓冲战场冲击。"],
    ["萌龙盔", "采用萌龙主题设计的4级头盔，外形俏皮，防护性能依然可靠。"],
    ["裂光盔", "以裂光为主题的5级战术头盔，强化外壳为危险区域中的行动提供保护。"],
    ["弑神盔", "以弑神为名的6级重型头盔，坚固的防护结构适合高强度交火。"],
    ["光明盔", "以光明为主题的7级防护头盔，为深入战场的佩戴者提供坚实保障。"],
    ["冥辉盔", "以冥辉为主题的8级战术头盔，多层复合装甲守护头部要害。"],
    //防弹衣
    ...
    ["兔萌甲", "兔萌主题的2级防弹衣，柔和的外观设计与坚固的防弹插板相结合。"],
    ["玄竹甲", "以玄竹为主题的3级护甲，层叠装甲覆盖躯干，为持续作战提供防护。"],
    ["绿龙甲", "绿龙主题的4级防弹衣，龙鳞般的装甲设计为核心部位提供保护。"],
    ["星轨甲", "以星轨为主题的5级战术护甲，强化插板能有效减轻正面交火的伤害。"],
    ["赤锋甲", "以赤锋为名的6级防弹衣，坚固的装甲结构适合迎战密集火力。"],
    ["圣翎甲", "以圣翎为主题的7级护甲，羽翼般的装饰之下是可靠的复合防弹层。"],
    ["噬星甲", "以噬星为主题的8级重型护甲，覆盖躯干要害，为高危行动提供保障。"],
    //背包
    ...
    ["云竹包", "以云竹为主题的3级背包，分区规整，可收纳60格补给与战利品。"],
    ["恐仔囊", "恐龙幼崽主题的4级背囊，可爱的外观中容纳着64格物资空间。"],
    ["天穹包", "以天穹为主题的5级运输背包，拥有68格容量，适合长时间搜集行动。"],
    ["赤辉囊", "以赤辉为主题的6级背囊，结实的收纳结构可容纳72格战场物资。"],
    ...
    ["焚天龙", "以焚天巨龙为主题的红色品质步枪，单发伤害较高，适合稳步推进时重创目标。"],
    //刀
...
export const ZRSJZ_PROP_PROPERTY: Map<string, { [Key: string]: number }> = new Map([
    ...
    ["DX9-冲锋枪", { "伤害": 30, "射程": 1300, "射速": 700, "弹夹": 35 }],
    ["K50-轻机枪", { "伤害": 45, "射程": 1400, "射速": 700, "弹夹": 35 }],
    ["RK77-轻机枪", { "伤害": 60, "射程": 1400, "射速": 700, "弹夹": 35 }],
    ["FS-霰弹枪", { "伤害": 60, "射程": 800, "射速": 300, "弹夹": 6 }],
    ["KK41-霰弹枪", { "伤害": 75, "射程": 800, "射速": 240, "弹夹": 8 }],
    ["ssv-狙击枪", { "伤害": 350, "射程": 2000, "射速": 100, "弹夹": 5 }],
    ["W76-狙击枪", { "伤害": 400, "射程": 2300, "射速": 120, "弹夹": 8 }],
    ["霜月狼", { "伤害": 80, "射程": 1400, "射速": 700, "弹夹": 32 }],
    ["裂海鲨", { "伤害": 100, "射程": 1500, "射速": 700, "弹夹": 32 }],
    ["焚天龙", { "伤害": 120, "射程": 1600, "射速": 700, "弹夹": 32 }],
    //刀
    ["战术匕首", { "伤害": 65 }],
    ["刺厌", { "伤害": 85 }],
    ["科技斧", { "伤害": 100 }],
...
export const ZRSJZ_WEAPONRY_TYPE: Map<string, string[]> = new Map([
    ["步枪", ["CN8-突击步枪", "DX9-冲锋枪", "K50-轻机枪", "RK77-轻机枪", "霜月狼", "裂海鲨", "焚天龙"]],
    ["狙击枪", ["ssv-狙击枪", "W76-狙击枪"]],
    ["散弹枪", ["FS-霰弹枪", "KK41-霰弹枪"]],
])
...
function CreateMapModeConfig(
    ...
    return {
        ...
        MapEnemy: new Map([
            ["持枪小兵", {
                HP: Math.round(300 * hpMultiplier),
            ...
            ["持刀小兵", {
                HP: Math.round(350 * hpMultiplier),
            ...
            ["盾牌兵", {
                HP: Math.round(880 * hpMultiplier),
                Harm: Math.round(8 * harmMultiplier),
                SpeedMultiplier: speedMultiplier,
                AttackIntervalMultiplier: attackIntervalMultiplier,
                Box: CreateMapBoxConfig(
        ...
        MapBoss: new Map([
            ["Boss1", {
                HP: Math.round(2000 * bossHPMultiplier),
            ...
            ["Boss2", {
                HP: Math.round(2200 * bossHPMultiplier),
                HarmMultiple: bossHarmMultiplier,
                SpeedMultiplier: speedMultiplier,
                CooldownMultiplier: attackIntervalMultiplier,
                Box: CreateMapBoxConfig(
            ...
            ["Boss3", {
                HP: Math.round(2500 * bossHPMultiplier),
                HarmMultiple: bossHarmMultiplier,
                SpeedMultiplier: speedMultiplier,
                CooldownMultiplier: attackIntervalMultiplier,
                Box: CreateMapBoxConfig(
...
/** 称号及解锁说明；keyword 为高亮关键词，实际获得状态以 OwnedTitles 为准。 */
export const ZRSJZ_AVATAR_FRAME_UNLOCK: Readonly<Record<string, {
    text: string; keyword?: string; difficulty?: number; kills?: number;
    percent?: number; pet?: string; skin?: string; video?: boolean;
}>> = {
    '1': { text: '默认拥有' },
    '2': { text: '击败简单模式\nBoss获得', keyword: 'Boss', difficulty: 1 },
    '3': { text: '击败普通模式\nBoss获得', keyword: 'Boss', difficulty: 2 },
    '4': { text: '击败困难模式\nBoss获得', keyword: 'Boss', difficulty: 3 },
    '5': { text: '击杀100个\n小怪获得', keyword: '100', kills: 100 },
    '6': { text: '解锁宠物皮肤\n深渊魔龙获得', keyword: '深渊魔龙', pet: '星核幼龙', skin: '深渊魔龙' },
    '7': { text: '成就完成度\n达到50%获得', keyword: '50%', percent: 50 },
    '8': { text: '成就完成度\n达到100%获得', keyword: '100%', percent: 100 },
    '9': { text: '', keyword: '', video: true },
    '10': { text: '', keyword: '', video: true },
};

export const ZRSJZ_TITLE_CONFIG: readonly {
    name: string;
    unlock: { type: 'default' | 'allBosses' } | { type: 'evacuations' | 'kills'; count: number } | { type: 'achievement'; id: string } | { type: 'milestone'; percent: number };
    unlockCondition: { text: string; keyword: string; color?: string };
}[] = [
        { name: '勇者', unlock: { type: 'default' }, unlockCondition: { text: '默认拥有', keyword: '勇者' } },
