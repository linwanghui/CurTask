...
export const ZRSJZ_PROP_CONFIG: Map<string, {
    ...
    ["兔月盔", { Name: "兔月盔", Quality: ZRSJZ_PROP_QUALITY.红色, GridType: ZRSJZ_GRID_TYPE._1x1, PropType: "头盔", UnitPrice: 6000000, MaxCount: 1 }],
    ["竹月盔", { Name: "竹月盔", Quality: ZRSJZ_PROP_QUALITY.红色, GridType: ZRSJZ_GRID_TYPE._1x1, PropType: "头盔", UnitPrice: 7500000, MaxCount: 1 }],
    ["萌龙盔", { Name: "萌龙盔", Quality: ZRSJZ_PROP_QUALITY.红色, GridType: ZRSJZ_GRID_TYPE._1x1, PropType: "头盔", UnitPrice: 9000000, MaxCount: 1 }],
    ["裂光盔", { Name: "裂光盔", Quality: ZRSJZ_PROP_QUALITY.红色, GridType: ZRSJZ_GRID_TYPE._1x1, PropType: "头盔", UnitPrice: 11000000, MaxCount: 1 }],
    ["弑神盔", { Name: "弑神盔", Quality: ZRSJZ_PROP_QUALITY.红色, GridType: ZRSJZ_GRID_TYPE._1x1, PropType: "头盔", UnitPrice: 13000000, MaxCount: 1 }],
    ["光明盔", { Name: "光明盔", Quality: ZRSJZ_PROP_QUALITY.红色, GridType: ZRSJZ_GRID_TYPE._1x1, PropType: "头盔", UnitPrice: 15000000, MaxCount: 1 }],
    ["冥辉盔", { Name: "冥辉盔", Quality: ZRSJZ_PROP_QUALITY.红色, GridType: ZRSJZ_GRID_TYPE._1x1, PropType: "头盔", UnitPrice: 18000000, MaxCount: 1 }],
    //防弹衣
    ...
    ["兔萌甲", { Name: "兔萌甲", Quality: ZRSJZ_PROP_QUALITY.红色, GridType: ZRSJZ_GRID_TYPE._2x2, PropType: "防弹衣", UnitPrice: 9000000, MaxCount: 1 }],
    ["玄竹甲", { Name: "玄竹甲", Quality: ZRSJZ_PROP_QUALITY.红色, GridType: ZRSJZ_GRID_TYPE._2x2, PropType: "防弹衣", UnitPrice: 11000000, MaxCount: 1 }],
    ["绿龙甲", { Name: "绿龙甲", Quality: ZRSJZ_PROP_QUALITY.红色, GridType: ZRSJZ_GRID_TYPE._2x2, PropType: "防弹衣", UnitPrice: 13000000, MaxCount: 1 }],
    ["星轨甲", { Name: "星轨甲", Quality: ZRSJZ_PROP_QUALITY.红色, GridType: ZRSJZ_GRID_TYPE._2x2, PropType: "防弹衣", UnitPrice: 16000000, MaxCount: 1 }],
    ["赤锋甲", { Name: "赤锋甲", Quality: ZRSJZ_PROP_QUALITY.红色, GridType: ZRSJZ_GRID_TYPE._2x2, PropType: "防弹衣", UnitPrice: 19000000, MaxCount: 1 }],
    ["圣翎甲", { Name: "圣翎甲", Quality: ZRSJZ_PROP_QUALITY.红色, GridType: ZRSJZ_GRID_TYPE._2x2, PropType: "防弹衣", UnitPrice: 22000000, MaxCount: 1 }],
    ["噬星甲", { Name: "噬星甲", Quality: ZRSJZ_PROP_QUALITY.红色, GridType: ZRSJZ_GRID_TYPE._2x2, PropType: "防弹衣", UnitPrice: 26000000, MaxCount: 1 }],
    //背包
    ...
    ["兔绒包", { Name: "兔绒包", Quality: ZRSJZ_PROP_QUALITY.红色, GridType: ZRSJZ_GRID_TYPE._2x2, PropType: "背包", UnitPrice: 7200000, MaxCount: 1 }],
    ["云竹包", { Name: "云竹包", Quality: ZRSJZ_PROP_QUALITY.红色, GridType: ZRSJZ_GRID_TYPE._2x2, PropType: "背包", UnitPrice: 9000000, MaxCount: 1 }],
    ["恐仔囊", { Name: "恐仔囊", Quality: ZRSJZ_PROP_QUALITY.红色, GridType: ZRSJZ_GRID_TYPE._2x2, PropType: "背包", UnitPrice: 10800000, MaxCount: 1 }],
    ["天穹包", { Name: "天穹包", Quality: ZRSJZ_PROP_QUALITY.红色, GridType: ZRSJZ_GRID_TYPE._2x2, PropType: "背包", UnitPrice: 13200000, MaxCount: 1 }],
    ["赤辉囊", { Name: "赤辉囊", Quality: ZRSJZ_PROP_QUALITY.红色, GridType: ZRSJZ_GRID_TYPE._2x2, PropType: "背包", UnitPrice: 15600000, MaxCount: 1 }],
    ["烬菱包", { Name: "烬菱包", Quality: ZRSJZ_PROP_QUALITY.红色, GridType: ZRSJZ_GRID_TYPE._2x2, PropType: "背包", UnitPrice: 18000000, MaxCount: 1 }],
    ["虚空匣", { Name: "虚空匣", Quality: ZRSJZ_PROP_QUALITY.红色, GridType: ZRSJZ_GRID_TYPE._2x2, PropType: "背包", UnitPrice: 21600000, MaxCount: 1 }],
    //枪
    ...
    ["霜月狼", { Name: "霜月狼", Quality: ZRSJZ_PROP_QUALITY.红色, GridType: ZRSJZ_GRID_TYPE._1x2, PropType: "枪", UnitPrice: 6500000, MaxCount: 1 }],
    ["裂海鲨", { Name: "裂海鲨", Quality: ZRSJZ_PROP_QUALITY.红色, GridType: ZRSJZ_GRID_TYPE._1x2, PropType: "枪", UnitPrice: 8000000, MaxCount: 1 }],
    ["焚天龙", { Name: "焚天龙", Quality: ZRSJZ_PROP_QUALITY.红色, GridType: ZRSJZ_GRID_TYPE._1x2, PropType: "枪", UnitPrice: 10000000, MaxCount: 1 }],
    //刀
...
export const ZRSJZ_PROP_DESCRIPTION: ReadonlyMap<string, string> = new Map([
    ...
    ["兔月盔", "以月兔为主题的7级防护头盔，可爱的造型下藏着坚固的复合装甲。"],
    ["竹月盔", "以竹影与月色为主题的8级头盔，层叠防护结构能有效缓冲战场冲击。"],
    ["萌龙盔", "采用萌龙主题设计的9级头盔，外形俏皮，防护性能依然可靠。"],
    ["裂光盔", "以裂光为主题的10级战术头盔，强化外壳为危险区域中的行动提供保护。"],
    ["弑神盔", "以弑神为名的11级重型头盔，坚固的防护结构适合高强度交火。"],
    ["光明盔", "以光明为主题的12级防护头盔，为深入战场的佩戴者提供坚实保障。"],
    ["冥辉盔", "以冥辉为主题的13级战术头盔，多层复合装甲守护头部要害。"],
    //防弹衣
    ...
    ["兔萌甲", "兔萌主题的7级防弹衣，柔和的外观设计与坚固的防弹插板相结合。"],
    ["玄竹甲", "以玄竹为主题的8级护甲，层叠装甲覆盖躯干，为持续作战提供防护。"],
    ["绿龙甲", "绿龙主题的9级防弹衣，龙鳞般的装甲设计为核心部位提供保护。"],
    ["星轨甲", "以星轨为主题的10级战术护甲，强化插板能有效减轻正面交火的伤害。"],
    ["赤锋甲", "以赤锋为名的11级防弹衣，坚固的装甲结构适合迎战密集火力。"],
    ["圣翎甲", "以圣翎为主题的12级护甲，羽翼般的装饰之下是可靠的复合防弹层。"],
    ["噬星甲", "以噬星为主题的13级重型护甲，覆盖躯干要害，为高危行动提供保障。"],
    //背包
    ...
    ["兔绒包", "兔绒主题的7级背包，内置宽敞收纳空间，可携带56格行动物资。"],
    ["云竹包", "以云竹为主题的8级背包，分区规整，可收纳60格补给与战利品。"],
    ["恐仔囊", "恐龙幼崽主题的9级背囊，可爱的外观中容纳着64格物资空间。"],
    ["天穹包", "以天穹为主题的10级运输背包，拥有68格容量，适合长时间搜集行动。"],
    ["赤辉囊", "以赤辉为主题的11级背囊，结实的收纳结构可容纳72格战场物资。"],
    ["烬菱包", "以烬菱为主题的12级背包，内部设有76格容量，便于整理搜集到的物资。"],
    ["虚空匣", "以虚空为主题的13级携行匣，拥有80格收纳空间，可装载大量战利品。"],
    //枪
...
export const ZRSJZ_PROP_PROPERTY: Map<string, { [Key: string]: number }> = new Map([
    ...
    ["霜月狼", { "伤害": 30, "射程": 1800, "射速": 700, "弹夹": 35 }],
    ["裂海鲨", { "伤害": 28, "射程": 1400, "射速": 800, "弹夹": 35 }],
    ["焚天龙", { "伤害": 35, "射程": 1500, "射速": 600, "弹夹": 35 }],
    //刀
    ["战术匕首", { "伤害": 65 }],
    ["刺厌", { "伤害": 85 }],
    ["科技斧", { "伤害": 100 }],
