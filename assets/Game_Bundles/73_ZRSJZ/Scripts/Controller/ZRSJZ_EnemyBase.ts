...
export abstract class ZRSJZ_EnemyBase extends Component {
    ...
    public Patrol(dt: number): void {
        ...
        // 独立于 A* 的卡住计时，避免 BuildPath 重置检测后无限重试同一巡逻点。
    ...
    private SelectNextPatrolPoint(): void {
        ...
        for (let attempt = 0; attempt < 16; attempt++) {
            ...
            if (Vec3.distance(this.node.worldPosition, candidate) > Math.max(0, this.EnemyConfig.PatrolArriveDistance)
