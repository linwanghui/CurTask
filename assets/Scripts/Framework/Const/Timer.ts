import { _decorator, director, Director, Scene, log, Node, game, Component } from 'cc';
const { ccclass, executionOrder, menu, disallowMultiple } = _decorator;

import Events from "../Utils/Events";
import { SCALE_TWEEN, TWEEN } from "../Utils/Tween";
...
//             return;
//         }
//         log("addPersistRootNode: TIMER");
//         let node = new Node("TIMER");
...
@ccclass('Timer')
@disallowMultiple @executionOrder(-1000) @menu("Framework/基础组件/Timer")
