...
export class Group {
    ...
    removeByCCObject(target: Object) {
...
export class Tween<T extends UnknownProps> {
    //    /** 绑定的cc.Object */
    private _bject;
    public get bject() { return this._bject; }
    private _object;
    private _group;
    private _isPaused;
    private _pauseStart;
     ...
     */
    isCCObjectValid() {
        if (this._object instanceof Object && !isValid(this._object, true)) {
            return false;
        }
        if (this._object instanceof Object && !isValid(this._object, true)) {
            return false;
