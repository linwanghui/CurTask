...
const files=['Panel/ZRSJZ_WarehousePanel.ts','Panel/ZRSJZ_PropPanel.ts','Controller/ZRSJZ_Player.ts','Controller/ZRSJZ_Joystick_Attack.ts','Skill/ZRSJZ_Skill_Button.ts','Service/ZRSJZ_BoosterShotService.ts'].map(p=>path.join(root,'assets/Game_Bundles/73_ZRSJZ/Scripts',p));
