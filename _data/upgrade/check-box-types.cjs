...
const files=['Unit/ZRSJZ_Box.ts','Controller/ZRSJZ_Player.ts','Controller/ZRSJZ_Joystick_Attack.ts','Skill/ZRSJZ_Skill_Button.ts','Service/ZRSJZ_BoosterShotService.ts'].map(p=>path.join(root,'assets/Game_Bundles/73_ZRSJZ/Scripts',p));
